...
VertexToPixel main(VertexShaderInput input)
{
	...
	// replace rotation section of 
	matrix unrotated_world_view = mul(world, view);
	unrotated_world_view[0][0] = 1;
	unrotated_world_view[0][1] = 0;
	unrotated_world_view[0][2] = 0;
	unrotated_world_view[1][0] = 0;
	unrotated_world_view[1][1] = 1;
	unrotated_world_view[1][2] = 0;
	unrotated_world_view[2][0] = 0;
	unrotated_world_view[2][1] = 0;
	unrotated_world_view[2][2] = 1;
	...
	matrix worldViewProj = mul(unrotated_world_view, projection);
